...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="downloadContacts" class="btn btn-default navbar-btn">Download contacts</button></li>
                            <li><button type="button" id="uploadContacts" class="btn btn-default navbar-btn">Upload contacts</button></li>
                        </ul>
        ...
        <script>
            ...
            $('#downloadContacts').click(function(){
                window.location.href='/download_contacts';
            });

            $('#uploadContacts').click(function(){
